...
This repository hosts the **Champawat GIS Viewer** — a web application for visualizing geographic and administrative data for Champawat District, Uttarakhand.
