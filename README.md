...
📖 About
This repository hosts the Champawat GIS Viewer — a web application for visualizing geographic and administrative data for Champawat District, Uttarakhand. It combines an interactive Leaflet map with an Express/Node backend and Gemini-powered AI capabilities.
...
Built for Champawat District 🏔️
